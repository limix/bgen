...
struct bgen_variant_metadata* bgen_variant_metadata_begin(struct bgen_file* bgen_file, int* error);
struct bgen_variant_metadata* bgen_variant_metadata_next(struct bgen_file* bgen_file, int* error);
struct bgen_variant_metadata* bgen_variant_metadata_end(struct bgen_file* bgen_file);
